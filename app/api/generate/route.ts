...
export async function POST(request: NextRequest) {
  ...
  const systemPrompt = `あなたは15年以上の経験を持つプロの家庭料理人です。家族のために心のこもった、本格的かつ現実的な献立を提案してください。旬の食材を活かし、栄養バランスと美味しさを両立した愛情のある料理を心がけてください。カップ麺・インスタント食品・冷凍食品は絶対に含めないでください。${noKnifeInstruction}

レシピの手順は料理初心者でもつまずかないよう、以下を必ず守ること：
・1ステップ＝1つの動作（短く明確に）
・火加減（弱火・中火・強火）と時間の目安を毎ステップ明記
