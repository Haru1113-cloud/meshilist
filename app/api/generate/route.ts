  ...
  const conditionInstruction = condition
    ? (() => {
        const map: Record<string, string> = {
          ...
          "ダイエット中": "ユーザーはダイエット中です。1食あたりの夕食カロリーを500kcal以下に抑えてください。たんぱく質をしっかり確保しつつ（1食20g以上）、糖質・脂質は控えめに。揚げ物・クリーム系・こってり料理は避け、蒸す・焼く・茹でるなど調理法でカロリーを抑えてください。それでも「おいしそう・食べたい」と思える満足感のある献立にしてください。",
        };
...
【料理名のつけ方】料理名は食欲をそそる魅力的な表現にしてください。「とろーり濃厚♪ エビのチーズクリームリゾット」「香ばしくてジューシー♪ 鶏もも肉の照り焼き」「ほっこり優しい♪ 根菜たっぷり豚汁」のように、食感・風味・温度感などを表す言葉を先頭に添えてください。記号は「♪」か「！」を1つだけ使い、つけすぎないこと。`;
